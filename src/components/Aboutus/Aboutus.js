  ...
  return (
    <div className="py-[6%] h-full w-full overflow-hidden flex justify-center ">
      <div className="flex flex-col md:flex-row h-auto md:h-[23rem] 2xl:h-[35rem] w-[85%] text-center md:text-start font-f-outfit gap-10">
        ...
        <div className="w-full md:w-[50%] lg:w[60%] flex flex-col justify-evenly lg:text-[1.1rem] 2xl:text-[1.5rem] 2xl:leading-8 text-sm">
            <h1 className="text-[2rem] md:text-[2rem] 2xl:text-[2.5rem] py-[5%] lg:py-0 leading-8 font-semibold">Who is Assets Rack?</h1>
          <p className="2xl:py-[4%]">
