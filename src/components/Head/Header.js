  ...
  return (
    <header className="w-full h-full bg-gradient">
      <nav className="text-white z-50 fixed top-0 w-full bg-white shadow-sm flex gradient h-[3.5rem] lg:h-[5rem] 2xl:h-[8rem] 2xl:px-4 justify-center items-center">
        <div className="flex lg:w-[90%] xl:w-[85%] w-[90%] justify-between items-center">
          ...
          <div
            className={`lg:w-auto lg:grid lg:static absolute z-10 top-[100%] bg-plan-gray lg:bg-transparent text-d-blue lg:text-white  h-[30rem] right-0 w-[80%] rounded-l-lg md:h-auto ${
              isOpen ? "visible" : "hidden"
            }`}
          >
            <ul className="h-full 2xl:text-3xl justify-evenly flex flex-col md:text-navy md:flex-row gap-2 xl:gap-4 2xl:gap-8 items-center md:justify-center font-semibold">
              ...
              <div className="flex flex-col lg:flex-row text-sm 2xl:text-lg gap-2 text-black font-bold">
                <button className="bg-white py-2 2xl:py-4 px-4 2xl:px-6 rounded hover:bg-yellow">
                  Create Account
                </button>
                <button className="bg-yellow py-2 2xl:py-4 px-4 2xl:px-6 rounded">
                  Sign in
                </button>
              </div>
            </ul>
