  ...
  return (
    <div className="py-[6%] h-full w-full overflow-hidden flex justify-center">
      <div className="flex flex-col md:flex-row h-auto md:h-[23rem] 2xl:h-[35rem] w-[85%] text-center md:text-start font-f-outfit gap-10">
        <div className="relative w-full h-full md:w-[50%] lg:[40%]">
          <img
            src={vedioImg}
            alt="vedio icon here"
            className="object-contain h-full w-full"
          />
          <div className="absolute p-4 bg-black/50 flex justify-center items-center rounded-full top-[35%] right-[40%] md:top-[40%] lg:top-[45%] lg:right-[45%]">
            <img
              src={playIcon}
              alt="play button"
              className="object-contain h-full w-[70%]"
            />
          </div>
        </div>
        <div className="w-full md:w-[50%] lg:w-[60%] flex flex-col justify-evenly lg:text-[1rem] 2xl:text-[2rem] font-light 2xl:leading-8 text-sm">
          <h1 className="text-[2rem] md:text-[1.8rem]  xl:text-[2rem] py-[5%] lg:py-0 leading-8 font-semibold">
            Who is Assets Rack?
          </h1>
          ...
          <div className="flex justify-center md:justify-start gap-2">
            <button className="bg-yellow px-4 py-2 lg:px-8 lg:py-4 2xl:px-9 2xl:py-7 rounded font-semibold hover:bg-white border border-yellow hover:border-light-gray md:whitespace-nowrap">
              Contact with Experts
            </button>
            <button className="border border-light-gray px-4 lg:px-8 rounded font-semibold md:whitespace-nowrap hover:bg-yellow hover:border-0">
              Join us Today
            </button>
          </div>
        </div>
